...
//メニュー定義
const KaniroboRMenus = {
    menuMotorID: {
        items: [
            { id: 'kaniroboR.menuMotorID.right', default: 'right', value: '11' },
            { id: 'kaniroboR.menuMotorID.left',  default: 'left',  value: '16' }
        ]
    },
    menuMotorDir: {
        items: [
            { id: 'kaniroboR.menuMotorDir.forward',  default: 'forward',  value: '1' },
            { id: 'kaniroboR.menuMotorDir.backward', default: 'backward', value: '0' }
        ]
    },
    menuMototPower: {
        items: [
...
function createMenuItems(menuKey) {
    return KaniroboRMenus[menuKey].items.map(item => ({
...
class KaniroboR {
    ...
    getInfo() {
        return {
            id: 'kaniroboR',
            name: formatMessage({ id: 'kaniroboR.name', default: 'KaniroboR' }),
	    ...
	    color1: '#4C97FF',
            ...
            blocks: [
                {
                    opcode: 'motor',
                    text: formatMessage({ id: 'kaniroboR.motor', default: 'set [ID] DC motor speed [DIR] [PWR]%' }),
                ...
                {
                    opcode: 'sensor',
                    text: formatMessage({ id: 'kaniroboR.sensor', default: 'light sensor [ID]' }),
                ...
                {
                    opcode: 'servo',
                    text: formatMessage({ id: 'kaniroboR.servo', default: 'set servo motor [ID] [AGL] degree' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
                ...
                {
                    opcode: 'puts',
                    text: formatMessage({ id: 'kaniroboR.puts', default: 'output [TEXT]' }),
                    blockType: BlockType.COMMAND,
                    arguments: {
