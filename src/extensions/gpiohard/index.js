...
const Setoutputvalue = {
    ZERO: "0",//数字の場合も「文字列」扱いしないとエラーが出る
    ONE: "1",
}
...
class GpioHard {
    ...
    get  SETVALUE () {
        return [
            {
                text: '0',
                value: Setoutputvalue.ZERO
            },
            {
                text: '1',
                value: Setoutputvalue.ONE
            }
        ];
    }
    //ブロック定義
    getInfo () {
        return {
            ...
            blocks: [
                ...
                {                    
                    opcode :'set_gpio_output_value',
                    text: formatMessage({
                        id: 'SET.GPIO.OUT.VALUE',
                        default:' command [NUM1] [SETVALUE]',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        NUM1: {
                        ...
                        SETVALUE: {
                            type: ArgumentType.NUMBER,
                            menu: 'setoutputvalue',
                            defaultValue: Setoutputvalue.ONE
                        },
                        
                    }
                },
                {                    
                    opcode :'input_gpio_value',
                    text: formatMessage({
                        id: 'INPUT.GPIO.VALUE',
                        default:' command [NUM1]',
                    }),
                ...
                {                    
                    opcode :'set_gpio_duty',
                    text: formatMessage({
                        id: 'SET.GPIO.DUTY',
                        default:' command [NUM1] [VALUE]',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
                        NUM1: {
                ...
                {
                    opcode :'set_gpio_frequency',
                    text: formatMessage({
                        id: 'SET.GPIO.FREQUENCY',
                        default:' command [NUM1] [VALUE]',
                    }),
                    blockType:BlockType.COMMAND,
                    arguments: {
